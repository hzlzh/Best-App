...
*经常会有朋友询问有哪些 Mac App 值得付费使用，  
于是制作了下面这个 List，用来收集和推荐付费App。*

如果大家也有好的App推荐，请 `Fork` 、 `Star` 或者通过 [issue] 提交 :)
...
★★★ | [Spotify] | 全语言文档手册速查 | $9.99/mon
★★★ | [Droplr Pro] | 分享文件，Pro支持自定义短链接域名，可跟踪点击 | $29.99
